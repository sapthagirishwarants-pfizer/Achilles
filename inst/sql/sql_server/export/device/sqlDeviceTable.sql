...
from 
	(select TRY_CAST(stratum_1 as bigint) stratum_1, count_value from @results_database_schema.achilles_results where analysis_id = 2100 GROUP BY analysis_id, stratum_1, count_value) ar1
	inner join
	(select TRY_CAST(stratum_1 as bigint) stratum_1, count_value from @results_database_schema.achilles_results where analysis_id = 2101 GROUP BY analysis_id, stratum_1, count_value) ar2
