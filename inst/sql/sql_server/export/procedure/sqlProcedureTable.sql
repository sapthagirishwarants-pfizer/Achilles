...
from 
	(select TRY_CAST(stratum_1 as bigint) stratum_1, count_value from @results_database_schema.achilles_results where analysis_id = 600 GROUP BY analysis_id, stratum_1, count_value) ar1
	inner join
	(select TRY_CAST(stratum_1 as bigint) stratum_1, count_value from @results_database_schema.achilles_results where analysis_id = 601 GROUP BY analysis_id, stratum_1, count_value) ar2
